...
from functions.ecg_handler import generate_plot, init_ecg_data, update_parameters, get_current_info

# Import UI components
from tools.ui_components import render_main_page, generate_bits_logo, generate_into_cps_logo
...
def register_routes(app):
    ...
    def serve_heart_model():
        ...
        from tools.model_loader import get_heart_model
...
def setup_static_paths(app):
    ...
    digital_twins_static = os.path.join(root_dir, 'digital_twins', 'static')
